...
- `cortex-plugin-2026-05-13.md` — **@cortex 当前真相** (vault 4 子目录 / **6 agent** / **13 skill** (PR1-4 整改 21→13 渐进披露) / 24 wrapper / 21 lint / 9 cron / MCP 写 + 搜索硬契约 / 评分字段强制 4+2 / 记忆 L0-L4 / D9 无参 + D10 AUTO_MODE)
