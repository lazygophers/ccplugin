...
| 94 | 2026-05-22 | 新增 cortex-image-understand skill | `48731868` | `master` |
| 93 | 2026-05-15 | install.sh opencode 软连同步 + 抽共享 | `c6379f23` | `master` |
| 92 | 2026-05-15 | install.sh codex 软连同步 | - | `master` |
| 91 | 2026-05-15 | cortex ingest website 路由修复 | `a37b8a71` | `master` |
...
| 73 | 2026-05-14 | cortex 大批量清理: fold/historian/preset 移除 + agent 路径对齐 + MCP 强制写契约 + neat-freak 精简 | `5d31f607`, `182ffc18`, `c4fd72ea`, `2e8a2930`, `f596e496`, `29249ead`, `ae7bc0dc` | `master` |
...
| 54 | 2026-05-12 | cortex MCP 3 骨架工具完整实现 | `091fdef5` | `master` |
| 53 | 2026-05-12 | cortex lint vault-misaligned (强制对齐) | `17d4f1c1` | `master` |
...
| 29 | 2026-05-12 | run.sh 丢弃 stdout NDJSON 防终端污染 | `1a002389` | `master` |
...
| 12 | 2026-05-11 | cortex P0 安全硬化 (masking + url_security + html_sanitize) | `89ce0b43` | `master` |
...
| 1 | 2026-05-10 | Deep study + 7 risk fixes batch | `7a1e7b34`, `45b7f54f`, `a9cb7d8b`, `f51ea8d5`, `b0c2405a`, `37fb982a`, `d39a8264` | `master` |
<!-- @@@/auto:session-history -->
