...
| 本文件提供 | 交叉参考 |
|-----------|---------|
| 字体配对选型（74 条） | [principles.md](principles.md) — 排版如何服从视觉层级 |
| 权重/行高全局规则 | [rules.md](rules.md) §6 — 排版与色彩 UX 规则 |
| Google Fonts 集成步骤 | [usability-a11y.md](usability-a11y.md) — 可读性 / 阅读障碍友好字体 |
| 配色如何配字体气质 | 姊妹 skill `design-color`（字体配色调色板） |
