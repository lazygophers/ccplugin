...
原生组件优先（免费获得无障碍 + 平台习惯 + 性能）。自定义只在原生不能满足品牌表达时。布局见 [layout.md](layout.md)，场景见 [scenes.md](scenes.md)，风格见 [style.md](style.md)。
...
换肤 / 暗模式 / 密度一处生效全局生效。详见 [style.md](style.md) 配色模板。
