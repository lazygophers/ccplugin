...
同一 HTML 产物要适配多种使用场景。场景维度决定何时切换、切换什么。本文件管「场景」，布局结构见 [layout.md](layout.md)，组件见 [components.md](components.md)，风格配色见 [style.md](style.md)。
...
| 输出形态 | 同一 HTML 导出 PNG/SVG/PDF/微信 | 见 [export.md](export.md) |
