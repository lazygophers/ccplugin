# fasthttp-skills 核心概念

fasthttp-skills 的设计目标是最大化性能和最小化内存分配。理解这些核心概念对于正确使用 fasthttp-skills 至关重要。
...
-----------------|--------------|--------------|------------
fasthttp-skills         | 1,200,000    | 0.83         | 3.2
...
fasthttp-skills 使用 sync.Pool 来管理请求和响应对象：
...
RequestCtx 会在多个请求之间被复用，这是 fasthttp-skills 性能的关键：
...
fasthttp-skills 优先使用 []byte 而非 string：
