...
```bash
# 从市场安装
claude plugin install novel@ccplugin-market

# 从本地安装
claude plugin install ./plugins/novels/novel
```
...
Assistant：使用 /novel brainstorm 命令
...
- [插件文档](https://github.com/lazygophers/ccplugin/tree/master/plugins/novels/novel)
