...
# Flutter Web 构建分析
flutter-skills build web --web-renderer canvaskit
flutter-skills build web --web-renderer html

# 分析包大小
flutter-skills build web --analyze-size
```
...
import 'package:flutter-skills/material.dart' deferred as ui;
...
import 'package:flutter-skills_service_worker/flutter_service_worker.dart';
...
```dart
// 使用 flutter-skills SEO 包
import 'package:flutter-skills_seo/flutter_seo.dart';
