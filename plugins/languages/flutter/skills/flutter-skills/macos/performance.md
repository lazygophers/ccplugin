...
# Flutter DevTools
flutter-skills run -d macos --profile
```
...
import 'package:flutter-skills_macos/window_size.dart';
...
```dart
// ✅ 添加 macOS 菜单栏
import 'package:flutter-skills/material.dart';
import 'package:flutter-skills/services.dart';
