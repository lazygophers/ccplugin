...
def get_db_path() -> str:
    ...
    if plugins_path:
        project_root = os.path.dirname(os.path.dirname(os.path.dirname(plugins_path)))
        return os.path.join(project_root, "lazygophers", "ccplugin", "memory", "memory.db")
    return os.path.join(os.path.dirname(__file__), "..", "..", "..", "lazygophers", "ccplugin", "memory", "memory.db")
