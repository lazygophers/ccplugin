...
- 关注 5 类问题: orphan / dead-wikilink / duplicate-alias / fleeting 老化 / path-naming-violation / i18n-frontmatter-lang-mismatch/002
...
1. 调 cortex-lint 拿 JSON 报告 (`python3 ~/.claude/plugins/marketplaces/ccplugin-market/plugins/tools/cortex/lint/run.py --vault <path> --json`)
