...
知识库/
├── 项目/                              本地项目
├── 来源/{代码仓库,网页,论文,书籍}/    外部输入
├── 领域/                              7 大预设
│   ├── 技术/{编程语言,数据库,基础设施,大数据,人工智能,前端,后端,移动端,运维}/...
│   ├── 金融/{投资,经济,会计,税务}/
│   ├── 生活/{美食,旅游,健康,家居,穿搭}/
│   ├── 工作/{管理,沟通,职业}/
│   ├── 学习/{语言,读书,课程}/
...
**知识库子目录**:
- `知识库/项目/`
- `知识库/来源/{代码仓库,网页,论文,书籍}/`
- `知识库/领域/{技术,金融,生活,工作,学习,创作,元学习}/`
  - `技术/{编程语言,数据库,基础设施,大数据,人工智能,前端,后端,移动端,运维}/`
  ...
  - `金融/{投资,经济,会计,税务}/` / `生活/{美食,旅游,健康,家居,穿搭}/` / `工作/{管理,沟通,职业}/` / `学习/{语言,读书,课程}/` / `创作/{写作,设计,音乐}/` / `元学习/{知识管理,效率,思维框架}/`
- `知识库/日记/{日,周,月,年}/`
- `知识库/反思/{洞察,连接,疑问}/`
- `知识库/收件箱/`
