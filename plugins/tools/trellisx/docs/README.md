...
| [concepts.md](concepts.md) | task / parent-child(任务级依次) vs subtask(任务内并行) / worktree 隔离单位=task / 执行载体 4 层 / 闭环 / 看板 |
| [skills-reference.md](skills-reference.md) | 7 skill 详解 (apply / flow / orchestrate / workspace / spec / cleanup / grill) |
