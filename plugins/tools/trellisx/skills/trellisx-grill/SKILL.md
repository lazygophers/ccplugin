...
**触发点**: trellisx-add planning 阶段 (flow 委托 `/trellisx-add --continue` 借 planning 时同触发) / trellisx-orchestrate step1 PRD 编排, **写 PRD 过程中** (非写完后审)。
