...
**迭代配置**：
- Simple（0-30分）：1 轮迭代，质量阈值 {1: 70}
- Moderate（31-60分）：2 轮迭代，质量阈值 {1: 60, 2: 80}
- Complex（61-80分）：3 轮迭代，质量阈值 {1: 60, 2: 75, 3: 85}
- VeryComplex（81-100分）：4 轮迭代，质量阈值 {1: 60, 2: 70, 3: 80, 4: 90}
