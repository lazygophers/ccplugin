...
|-------|------|---------|------|--------|---------|
| 1 | retry | 首次失败/临时错误 | 0s | Phase 5 | **必须立即**继续执行 |
| 2 | debug | 重试失败/逻辑错误 | 2s | Phase 5 | **必须立即**继续执行 |
| 3 | replan | 调试失败/计划缺陷 | 4s | Phase 4(自动批准) | **必须立即**重新规划 |
| 4 | ask_user | 重规划失败/停滞 | - | 用户决定 | 获得响应后**必须立即**继续 |
| 5 | escalate | 超出能力/用户请求 | - | 高级agent | **必须立即**升级处理 |
