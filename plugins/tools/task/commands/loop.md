...
│ files: src/models/user.py           │  │ files: src/utils/helper.py          │
└──────────────┬──────────────────────┘  └──────────────┬──────────────────────┘
               │                                        │
               └──────────────┬─────────────────────────┘
                              ↓ 等待全部完成
...
│ agent: coder                        │  │ agent: coder                        │
│ files: src/api/auth.py              │  │ files: src/services/processor.py    │
│ (依赖 T1)                           │  │ (依赖 T2)                           │
└──────────────┬──────────────────────┘  └──────────────┬──────────────────────┘
               │                                        │
               └──────────────┬─────────────────────────┘
...
### 简要说明
分 5 个子任务实现用户认证功能：T1/T2 并行开发基础模块，T3/T4 并行开发业务逻辑，T5 集成测试。
```
