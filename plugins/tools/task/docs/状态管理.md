...
stateDiagram-v2
    ...
    style pending fill:#9E9E9E,stroke:#9E9E9E,color:#fff
    style explore fill:#FF9800,stroke:#FF9800,color:#fff
    style align fill:#009688,stroke:#009688,color:#fff
    ...
    style new_input fill:#009688,stroke:#009688,color:#fff,stroke-dasharray:5
```
