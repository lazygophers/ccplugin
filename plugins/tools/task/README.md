...
- **Agents（13个）**：任务编排（planner/verifier）+ 项目探索（9个 explorer）+ 辅助（adjuster/prompt-optimizer）
- **Skills**：核心流程（loop/planner/verifier/adjuster/prompt-optimizer）+ 探索（10个）+ 辅助（hooks 等）
