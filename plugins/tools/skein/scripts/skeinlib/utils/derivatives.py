...
DERIVATIVES: list[Derivative] = [
    ...
    # 历史遗留标记 (flow-gate / dispatch 提醒已撤): 存量工作区仍可能有这三个文件, 保留忽略项,
    # 不留代码路径。
    Derivative(".edit-tally", "已废弃 (flow-gate 已撤)"),
    Derivative(".edit-tally.warned", "已废弃 (flow-gate 已撤)"),
    Derivative(".dispatch.warned", "已废弃 (派发提醒已撤)"),
