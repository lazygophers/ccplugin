...
5. grill 硬门 → Skill(skein-grill)，弱点表逐条裁决补回
6. confirm 人审门 → skein task confirm --summary → AskUserQuestion → --approved
```
...
planning 产物产出后、`skein task confirm` 前必跑 grill。按 skein-grill 审查轴逐条逼问，弱点表交用户裁决。有未裁决弱点禁 confirm。
