---
name: skein-flow
description: "SKEIN task 闭环编排器。$1 路由阶段；$1=plan 或含 --plan 时路由到 skein-plan skill；执行过程唯一真值源在 references/flow-loop.md。"
user-invocable: true
argument-hint: "[flow|plan|exec|check|finish|redo] [任务描述/ID] [--plan] (全空=清空全部未完成 task; plan/--plan=路由 skein-plan)"
