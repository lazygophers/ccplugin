...
2. **取文风基准** — 读 `大纲/总纲.md` 中 novelist-craft 选定的叙事镜片记录（字段: 叙事镜片/narrative_lens）; 去味要服务该风格, 不是套通用模板。无记录 → 读 `元数据/风格基准.md`; 仍无 → 跳过基准约束, 仅按三层通用 tells 去味。
...
5. **🔴 熔铸/指纹互消(高 AI 味段落专用，人味分 < 70 触发)** — 对改完后人味分仍 < 70 的段落，用指纹互消法打散 AI 公约数:
